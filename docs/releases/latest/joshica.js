...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   AriaLabelCheckBehavior: () => (/* reexport safe */ _experiences_a11y_aria_label_check_behavior__WEBPACK_IMPORTED_MODULE_0__.AriaLabelCheckBehavior)\n/* harmony export */ });\n/* harmony import */ var _experiences_a11y_aria_label_check_behavior__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./experiences/a11y/aria-label-check.behavior */ \"./src/experiences/a11y/aria-label-check.behavior.ts\");\n\n\n\n\n//# sourceURL=webpack://@joshica/ux/./src/experiences.ts?\n}");

/***/ }),

/***/ "./src/experiences/a11y/aria-label-check.behavior.ts":
/*!***********************************************************!*\
  !*** ./src/experiences/a11y/aria-label-check.behavior.ts ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   AriaLabelCheckBehavior: () => (/* binding */ AriaLabelCheckBehavior)\n/* harmony export */ });\n/* harmony import */ var _joshica_ux_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @joshica/ux/core */ \"./src/core.ts\");\nvar __esDecorate = (undefined && undefined.__esDecorate) || function (ctor, descriptorIn, decorators, contextIn, initializers, extraInitializers) {\n    function accept(f) { if (f !== void 0 && typeof f !== \"function\") throw new TypeError(\"Function expected\"); return f; }\n    var kind = contextIn.kind, key = kind === \"getter\" ? \"get\" : kind === \"setter\" ? \"set\" : \"value\";\n    var target = !descriptorIn && ctor ? contextIn[\"static\"] ? ctor : ctor.prototype : null;\n    var descriptor = descriptorIn || (target ? Object.getOwnPropertyDescriptor(target, contextIn.name) : {});\n    var _, done = false;\n    for (var i = decorators.length - 1; i >= 0; i--) {\n        var context = {};\n        for (var p in contextIn) context[p] = p === \"access\" ? {} : contextIn[p];\n        for (var p in contextIn.access) context.access[p] = contextIn.access[p];\n        context.addInitializer = function (f) { if (done) throw new TypeError(\"Cannot add initializers after decoration has completed\"); extraInitializers.push(accept(f || null)); };\n        var result = (0, decorators[i])(kind === \"accessor\" ? { get: descriptor.get, set: descriptor.set } : descriptor[key], context);\n        if (kind === \"accessor\") {\n            if (result === void 0) continue;\n            if (result === null || typeof result !== \"object\") throw new TypeError(\"Object expected\");\n            if (_ = accept(result.get)) descriptor.get = _;\n            if (_ = accept(result.set)) descriptor.set = _;\n            if (_ = accept(result.init)) initializers.unshift(_);\n        }\n        else if (_ = accept(result)) {\n            if (kind === \"field\") initializers.unshift(_);\n            else descriptor[key] = _;\n        }\n    }\n    if (target) Object.defineProperty(target, contextIn.name, descriptor);\n    done = true;\n};\nvar __runInitializers = (undefined && undefined.__runInitializers) || function (thisArg, initializers, value) {\n    var useValue = arguments.length > 2;\n    for (var i = 0; i < initializers.length; i++) {\n        value = useValue ? initializers[i].call(thisArg, value) : initializers[i].call(thisArg);\n    }\n    return useValue ? value : void 0;\n};\nvar __setFunctionName = (undefined && undefined.__setFunctionName) || function (f, name, prefix) {\n    if (typeof name === \"symbol\") name = name.description ? \"[\".concat(name.description, \"]\") : \"\";\n    return Object.defineProperty(f, \"name\", { configurable: true, value: prefix ? \"\".concat(prefix, \" \", name) : name });\n};\n\n\nlet AriaLabelCheckBehavior = (() => {\n    let _classDecorators = [(0,_joshica_ux_core__WEBPACK_IMPORTED_MODULE_0__.Experience)({\n            id: 'ariaLabelCheckBehavior'\n        })];\n    let _classDescriptor;\n    let _classExtraInitializers = [];\n    let _classThis;\n    let _classSuper = _joshica_ux_core__WEBPACK_IMPORTED_MODULE_0__.CoreExperience;\n    var AriaLabelCheckBehavior = _classThis = class extends _classSuper {\n        /**\n         * onRefresh event hook.\n         */\n        onRefresh() {\n            if (!this.isAriaLabelPresent()) {\n                console.warn('A11y warning: HtmlExperienceElement[' + this.element.uxid + '] is missing an aria-label or an aria-labelledby attribute.');\n            }\n        }\n        /**\n         * Checks to see if the aria-label or aria-labeledby attribute is present on the element.\n         */\n        isAriaLabelPresent() {\n            return this.element.hasAttribute('aria-label') && !this.element.hasAttribute('aria-labelledby');\n        }\n    };\n    __setFunctionName(_classThis, \"AriaLabelCheckBehavior\");\n    (() => {\n        var _a;\n        const _metadata = typeof Symbol === \"function\" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;\n        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: \"class\", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);\n        AriaLabelCheckBehavior = _classThis = _classDescriptor.value;\n        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });\n        __runInitializers(_classThis, _classExtraInitializers);\n    })();\n    return AriaLabelCheckBehavior = _classThis;\n})();\n\n\n\n//# sourceURL=webpack://@joshica/ux/./src/experiences/a11y/aria-label-check.behavior.ts?\n}");
